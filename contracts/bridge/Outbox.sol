...
contract Outbox is DelegateCallAware, IOutbox {
    ...
    function recordOutputAsSpent(
        ...
        if (roots[calcRoot] == bytes32(0)) revert UnknownRoot(calcRoot);//rollup 通过 updateSendRoot 来更新
        ...
        spent[spentIndex] = (replay | bytes32(1 << bitOffset));// 防止重放
    }
